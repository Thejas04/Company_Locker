...
public class AppDetails {
	...
	public static boolean welcome() {
		...
		System.out.println(" Thejas M N \n");
		System.out.println(" Organisation:Code Consultancy Services\n");
				
		System.out.println("For Any enquire, Contact no :+919591165507\n\n Email:Tejastejasmn1999@gmail.com\n");
	...
	public static void choices() {
		while (true) {
			...
			System.out.println("Enter 1: List current file names in ascending order");
			System.out.println("Enter 2: List user interfaces ");
			System.out.println("Enter 3: Close Application\n");
			int n = sc.nextInt();
			switch (n) {
			case 1:
	...
	public static void userInterfaces() {
		System.out.println("\n\n Please Enter your choice \n");
		System.out.println("Enter 1: Add a file to the existing directory list");
		System.out.println("Enter 2: Delete a user specified file from the existing directory list");
		System.out.println("Enter 3: Search a user specified file from the main directory");
		System.out.println("Enter 4: Navigate back to the main context\n");
		int n = sc.nextInt();
		switch (n) {
		case 1:
			addFile();
